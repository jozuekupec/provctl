...
var bindings = []binding{
	...
	{Action: actionPicker, Group: "Navigation", Keys: []string{"s"}, Label: "s", Help: "return to subscription picker", Bar: "s subscriptions", Short: "s", Priority: 1, Contexts: contextsWorkspace},
	...
	{Action: actionRefresh, Group: "Actions", Keys: []string{"r"}, Label: "r", Help: "refresh subscriptions", Bar: "r refresh", Short: "r", Priority: 5, Contexts: []shortcutContext{shortcutPicker}},
